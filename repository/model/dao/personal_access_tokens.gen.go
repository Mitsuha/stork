...
type personalAccessToken struct {
	...
	TokenableID   field.Int
	Name          field.String
	Token         field.String
	Abilities     field.Field
...
func (p *personalAccessToken) updateTableName(table string) *personalAccessToken {
	...
	p.TokenableID = field.NewInt(table, "tokenable_id")
	p.Name = field.NewString(table, "name")
	p.Token = field.NewString(table, "token")
	p.Abilities = field.NewField(table, "abilities")
...
func (p personalAccessTokenDo) FindAll() (result []*model.PersonalAccessToken, err error) {
	var generateSQL strings.Builder
	generateSQL.WriteString("SELECT * FROM personal_access_tokens ")
...
func (p personalAccessTokenDo) FindByID(id int) (result *model.PersonalAccessToken, err error) {
	var params []interface{}

	var generateSQL strings.Builder
	params = append(params, id)
	generateSQL.WriteString("SELECT * FROM personal_access_tokens WHERE id = ? ")
...
func (p personalAccessTokenDo) WhereIDAndToken(id string, token string) (result *model.PersonalAccessToken, err error) {
	var params []interface{}

	var generateSQL strings.Builder
	params = append(params, id)
	params = append(params, token)
	generateSQL.WriteString("SELECT * FROM personal_access_tokens WHERE id = ? AND token = ? ")

...
func newUser(db *gorm.DB, opts ...gen.DOOption) user {
	...
	_user.InvitationToken = field.NewField(tableName, "invitation_token")
	_user.InvitedAt = field.NewTime(tableName, "invited_at")
	_user.InvitationAcceptedAt = field.NewTime(tableName, "invitation_accepted_at")
	_user.InvitedByID = field.NewField(tableName, "invited_by_id")
...
type user struct {
	...
	InvitationToken      field.Field
	InvitedAt            field.Time
	InvitationAcceptedAt field.Time
	InvitedByID          field.Field
...
func (u *user) updateTableName(table string) *user {
	...
	u.InvitationToken = field.NewField(table, "invitation_token")
	u.InvitedAt = field.NewTime(table, "invited_at")
	u.InvitationAcceptedAt = field.NewTime(table, "invitation_accepted_at")
	u.InvitedByID = field.NewField(table, "invited_by_id")
...
func (u *user) fillFieldMap() {
	...
	u.fieldMap["invitation_token"] = u.InvitationToken
	u.fieldMap["invited_at"] = u.InvitedAt
	u.fieldMap["invitation_accepted_at"] = u.InvitationAcceptedAt
	u.fieldMap["invited_by_id"] = u.InvitedByID
}
...
func (u userDo) FindAll() (result []*model.User, err error) {
